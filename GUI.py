...
class PDFViewer(QMainWindow):
    """
    Class responsible for load the technical documentation in PDF format.
    source: https://gist.github.com/glowinthedark/d9cd06212d06c6148589772dff448f9b
    """
...
class CTViewer(QMainWindow):
    """ 
    Class for handling the main window of the SegMed's application. 
    """
    def __init__(self):
        super().__init__()
    ...
    def render_3D_visualization(self, seg_file=None):
        """
        Method to render 3D visualization of the segmented data.
    ...
    def init_ui(self):
        """ 
        Method for User Interface (UI) initialization.
    ...
    def setup_menu_bar(self):
        """ 
        Method for setting up the menu bar with File, Edit, View, Help, and About menu actions.
        """
    ...
    def upload_data(self):
        """ Method to enable uploading the CT scans directly to the SegMed's application. 
        """
    ...
    def upload_ct_scan(self):
        """ Method to handle uploading CT scans for the scans that haven't been segmented yet.
        """
    ...
    def upload_segmented_ct_scan(self):
        """
        Method to to handle uploading CT scans for the scans already segmented.
        """
    ...
    def segment_image(self):
        """
        Method for managing segmentation of the uploaded CT scan.
        """
    ...
    def render_3D_visualization_seg(self, seg_data):
        """
        Method for rendering 3D visualization from segmentation data.
        """
    ...
    def update_img_placeholders(self):
        """ 
        Method for updating image placeholders (sagittal, coronal, axial) with the first slice from each view.
        """
        ...
        if self.scan_list_sagittal:
            ...
            self.slider_sagittal.setValue(0) # resetting slider position to the first slice
    ...
    def save_segmentation(self):
        """ 
        Method for saving segmented CT scans to a file.
        """
    ...
    def close_segmentation(self):
        """
        Method for closing the segmentation and resetting the application to its initial state.
        """
    ...
    def manage_view(self):
        """ 
        Method for handling 'Manage view' action from the menu bar.
        """
        ...
        # opening dialog for organ selection to display in 3D view:
    ...
    def update_3D_view(self, selected_organs):
        """ Method for updating 3D view with the selected organs. 
        """

        self.log_message(f"Updating view for the selected organs: {selected_organs}")
    ...
    def calculate_volume(self):
        """ Method for calculating the volume of a given organ from the displayed 3D segmentation. 
        """
        ...
        try:
            ...
            # checking if any pf the organs, defined in the dataset, are found in the current segmentation:
    ...
    def calculate_volume_for_organ(self, organ_name):
        ...
        """ 
        Method for calculating volume of a given organ from the displayed 3D segmentation:
    ...
    def zoom_in(self):
        """  
        Method for handling 'Zoom in' action from the menu bar.
        """
    ...
    def zoom_out(self):
        """
        Method for handling 'Zoom out' action from the menu bar.
        """
    ...
    def help(self):
        """ 
        Method for handling 'Help' action from the menu bar.
        """
    ...
    def report_problem(self):
        """ 
        Method for handling 'Report problem' action from the menu bar.
        """
    ...
    def contribute(self):
        """ 
        Method for handling 'Contribute' action from the menu bar.
        """
    ...
    def about(self):
        """ 
        Method for displaying "About" dialog with application name, its version, and original authors.
        """
    ...
    def slider_move(self):
        """ 
        Method for handling image slider movement for each image placeholder.
        """
            ...
            if curr_sagittal < len(self.scan_list_sagittal):
                ...
                if hasattr(self, 'seg_sagittal') and self.seg_sagittal and curr_sagittal < len(self.seg_sagittal): # source: https://www.w3schools.com/python/ref_func_hasattr.asp
                    ...
                    pixmap_overlay = overlay_slices(
                        ...
                        class_to_color=class_to_color  # mapping class to color
                    )
