...
def convert_to_stl(nifti, out_path):
    """ 
    Method for converting a numpy array (NIfTI data) to STL file 
    using marching cubes algorithm:  https://www.cs.carleton.edu/cs_comps/0405/shape/marching_cubes.html
    """
