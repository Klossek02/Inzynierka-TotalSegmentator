...
# function for preparing CT scan for segmentation by resizing, normalizing and converting it into proper format: 
...
# function that takes a preprocessed image tensor and uses a trained model to perform segmentation: 
...
# function forsaving the segmentation:
...
# function for segmenting CT scan with TotalSegmentator model; source: https://github.com/wasserth/TotalSegmentator/blob/master/README.md?fbclid=IwZXh0bgNhZW0CMTAAAR10eO8vUynsUgYRJ2BqMUkMXDqHeUTa1r5RjxZrnJrmfHXOuecCBASiL1I_aem_qLQKfOT9tQP_LVGT_npG5A
